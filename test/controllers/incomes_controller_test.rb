...
class IncomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create income' do
    assert_difference('Income.count') do
      post incomes_url, params: { income: { period: @income.period, product_id: @income.product_id, value: @income.value } }
    end
  ...
  test 'should update income' do
    patch income_url(@income), params: { income: { period: @income.period, product_id: @income.product_id, value: @income.value } }
